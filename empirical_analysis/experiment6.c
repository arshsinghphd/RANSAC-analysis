 ...
 * experiment6.c
 *
 * Experiment 6: How does RANSAC performance scale with dataset size N?
 *
 ...
 *
 * Output:
 *     (orignal exp 6 unreported, this was called exp7
 *      changed file name, but not changing csv name or make file)
 *     results/exp7.csv
